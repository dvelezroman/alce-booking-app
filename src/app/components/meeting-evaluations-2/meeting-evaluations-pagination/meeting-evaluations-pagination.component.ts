...
@Component({
  selector: 'app-meeting-evaluations-pagination',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ],
  templateUrl: './meeting-evaluations-pagination.component.html',
  styleUrl: './meeting-evaluations-pagination.component.scss',
})
export class MeetingEvaluationsPaginationComponent implements OnInit {
