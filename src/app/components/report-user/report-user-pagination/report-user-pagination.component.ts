...
@Component({
  selector: 'app-report-user-pagination',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ],
  templateUrl: './report-user-pagination.component.html',
  styleUrl: './report-user-pagination.component.scss',
})
export class ReportUserPaginationComponent implements OnInit {
