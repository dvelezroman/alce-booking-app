...
navItems: SidebarNavItem[] = [
  ...
  { icon: 'assessment', text: 'Tareas de etapa', route: '/dashboard/stage-assessment-student', roles: [UserRole.STUDENT] },
  { icon: 'assessment', text: 'Exámenes', route: '/dashboard/platform-assessments', roles: [UserRole.STUDENT] },
