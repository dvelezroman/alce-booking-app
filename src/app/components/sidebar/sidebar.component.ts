...
navItems: SidebarNavItem[] = [
  ...
  { icon: 'group', text: 'Agenda', route: '/dashboard/searching-meeting-v2', roles: [UserRole.ADMIN] },
  ...
  { icon: 'asistencias-instructor', text: 'Asistencias Instructores', route: '/dashboard/attendance-instructor-v2', roles: [UserRole.ADMIN] },
  ...
  { icon: 'create', text: 'Registrar estudiante', route: '/dashboard/create-students', roles: [UserRole.ADMIN] },
  // { icon: 'create', text: 'Crear Admin / Instructor', route: '/dashboard/create-instructors', roles: [UserRole.ADMIN] },
  { icon: 'create', text: 'Registrar personal', route: '/dashboard/create-staff', roles: [UserRole.ADMIN] },
  ...
  { icon: 'reportes', text: 'Alertas tempranas', route: '/dashboard/early-warnings', roles: [UserRole.ADMIN] },
  ...
  { icon: 'notifications', text: 'Historial', route: '/dashboard/notifications-historial', roles: [UserRole.ADMIN] },
  ...
  { icon: 'notifications', text: 'Enviadas', route: '/dashboard/notifications-sent-v2', roles: [UserRole.ADMIN, UserRole.INSTRUCTOR],  },
  ...
  ngOnInit() {
      ...
      items: [
...

        {
          ...
          children: [
            ...
            this.findNavItemByRoute('/dashboard/early-warnings'),
          ].filter(item => item.roles.includes(role)),
        },
    ...
    },
    {
      ...
      items: [
        ...
        this.findNavItemByRoute('/dashboard/broadcast-groups-v2'),
        // this.findNavItemByRoute('/dashboard/notifications-status'),
        this.findNavItemByRoute('/dashboard/notifications-historial'),
        ...
        this.findNavItemByRoute('/dashboard/notifications-sent-v2'),
      ].filter(item => item.roles.includes(role))
    },
    {
      title: 'WhatsApp',
